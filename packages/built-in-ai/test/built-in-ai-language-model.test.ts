...
I'll follow up once I have the results.`,
    ...
    it("should emit multiple tool calls when parallel execution is enabled", async () => {
      mockPrompt.mockResolvedValue(`\`\`\`tool_call
{"name": "getWeather", "arguments": {"location": "Seattle"}}
{"name": "getNews", "arguments": {"topic": "Seattle"}}
\`\`\``);
...
Running the tool now.`;
    ...
    it("should emit multiple streaming tool calls when parallel execution is enabled", async () => {
      const streamingResponse = `\`\`\`tool_call
{"name": "getWeather", "arguments": {"location": "Seattle"}}
{"name": "getNews", "arguments": {"topic": "Seattle"}}
\`\`\`
